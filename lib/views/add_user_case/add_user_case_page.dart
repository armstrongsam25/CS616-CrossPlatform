...
class _AddUserCasePageState extends State<AddUserCasePage> {
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                            ...
                            SizedBox(height: 15,),
                            Container(alignment: Alignment.centerLeft, child: Text("Suspected Signature: "),),
                            SizedBox(height: 15,),
                       CameraWidget(callback: cameraCallBack), 

                            SizedBox(height: 15,),
                            Container(alignment: Alignment.centerLeft, child: Text("Original Signature: "),),
                            SizedBox(height: 15,),
                       CameraWidget(callback: cameraCallBack),
  ...
  child: ElevatedButton(
    ...
    onPressed: () async { 
                      ...
                      Status status= await AddUserCasePageController.to.addUserCase(_userCaseName.text);
                      SnackBar snackBar= CommonWidgets.getAweSomeSnackBar(status);
                      if(status.code == STATUS_CODES.USER_CASE_ADDED_SUCCESSFULL.code){
